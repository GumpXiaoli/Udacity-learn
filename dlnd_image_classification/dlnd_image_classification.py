...
def conv2d_maxpool(x_tensor, conv_num_outputs, conv_ksize, conv_strides, pool_ksize, pool_strides):
    ...
    x = tf.nn.relu(x)
    x = tf.nn.max_pool(x, ksize=list((1,)+pool_ksize+(1,)), strides=list((1,)+pool_strides+(1,)),padding='SAME')
    return x 
...
def flatten(x_tensor):
    ...
    FlattenedImageSize = shape[1] * shape[2] * shape[3]
